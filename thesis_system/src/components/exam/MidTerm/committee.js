...
const getmarks=()=>{
  Axios.post('http://localhost:80/thesis/midCommittee/get_committe_marks.php/',{id:id})
  .then(response=>{
...
const update=()=>
{
  ...
  Axios.post('http://localhost:80/thesis/midCommittee/update_teachername.php/',
  {id:id,
  teachername:teacher})
  .then(response=>{
...
const deleteteacher=(id)=>{
  Axios.post('http://localhost:80/thesis/midCommittee/delete.php/',
  {id:id
 })
  .then(response=>{
